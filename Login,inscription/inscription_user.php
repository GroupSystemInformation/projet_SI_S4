                       ...
                       <div class="form-row ">
                         ...
                         <div class="form-group col-lg-4">
                           ...
                           <select class="form-control wide" name="genre"  id="genre">
                             ...
                             <option value="Normal distribution ">Masculin</option>
                             <option value="Normal distribution ">Féminin</option>
                           </select>
                         </div>
                         <div class="form-group col-lg-4">
                           <label for="taille">Taille(m)</label>
                           <input type="number" class="form-control" id="taille" name="taille" placeholder="">
                         </div>
                         <div class="form-group col-lg-4">
                           <label for="poids">Poids(kg)</label>
                           <input type="number" class="form-control" id="poids" name="poids" placeholder="">
                         </div>
                         <div class="form-group col-lg-4">
                           <label for="objectif">Objectif</label>
                           <select name="objectif" class="form-control wide" id="objectif">
                             <option value="Normal distribution ">Sélectionnez un objectif</option>
                             <option value="Normal distribution ">Réduire du poids </option>
                             <option value="Normal distribution ">Augmenter du poids</option>
                           </select>
                         </div>
                       </div>
                       <div class="form-row ">
