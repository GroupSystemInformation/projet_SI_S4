...
<html lang="en">
   ...
   <body>
      <h1><a href="<?php echo base_url('crud_controller/user_logout')?>">Se deconnecter</a></h1>
         ...
         <div class="header_section">
            <div class="container">
               <nav class="navbar navbar-light justify-content-between">
                  ...
                  <a class="logo" href=""><img src="<?php echo base_url('assets/images/logo.png'); ?>"></a></a>
                     ...
                     <form id="user_login_form" method="post" action="<?php echo base_url('crud_controller/user_login'); ?>">
                       ...
                       <div class="bm-4 ">
                         <div class="form-group col-lg-4">
                           ...
                           <input type="email" name ="mail" class="form-control" id="mail" placeholder="">
                         </div>
                         <div class="form-group col-lg-4">
                           <label for="mdp">Mot de pass</label>
                           <input type="password" name="mdp" class="form-control" id="mpd" placeholder="XXXXXXXXXX">
                         </div>
                       </div>
                       <div>
